...
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'SP_RSFONE'));
...
SELECT /*+ gather_plan_statistics */
 ...
 ORDER BY Max (line_no) KEEP (DENSE_RANK FIRST ORDER BY lev)
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'SP_RSFTWO'));
...
SELECT  /*+ gather_plan_statistics */
 ...
 GROUP BY node
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'SP_GTTRSF_I'));
...
SELECT /*+ gather_plan_statistics */
 ...
 ORDER BY Max (line_no) KEEP (DENSE_RANK FIRST ORDER BY lev)
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'SP_GTTRSF_Q'));
