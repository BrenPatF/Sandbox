...
ORDER BY bin 
/ 
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XPOS'));
...
ORDER BY bin 
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XPLF'));
...
ORDER BY bin 
/ 
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XRSF_D'));
...
SELECT /*+ gather_plan_statistics XINS */
  ...
  FROM items;
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XINS'));
...
ORDER BY bin 
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XRSF_T'));
...
ORDER BY bin 
/
EXECUTE Utils.W(Utils.Get_XPlan (p_sql_marker => 'XMOD'));
SET TIMING OFF
